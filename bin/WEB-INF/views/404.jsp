      ...
      <div class="row">        
        ...
        <!-- start error page -->
          <div class="error_page">
            <img class="wow shake" src="img/error-img.png" alt="error-img">
            <p><span>Ohh.....</span>You Requested The Page Could Not Be Found!</p>
            <a href="index.html">Home</a>
            <!-- start recent post -->
            <div class="erropr_recentpost">
              <h2><a href="category-archive.html">Recent Post</a></h2>
